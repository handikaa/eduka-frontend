...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="absolute left-0 top-30 h-72 w-72 rounded-full bg-primary/30 blur-3xl" />
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-72px)] max-w-7xl items-center gap-12 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-16">
        <div>
          <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-primary/20 bg-primary/5 px-5 py-3 text-sm font-semibold text-primary">
          ...
          <h1 className="max-w-3xl text-4xl font-extrabold leading-tight tracking-tight text-gray-950 sm:text-5xl lg:text-6xl">
            ...
            <span className="text-primary">Eduka</span>
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            ...
            <Link href="/courses">
              <Button
                variant="outline"
                className="w-full rounded-full border-primary/20 bg-white px-7 py-3 text-base font-bold text-primary hover:bg-primary/5 sm:w-auto"
              >
          ...
          <div className="mt-10 flex flex-col gap-5 sm:flex-row sm:items-center">
            ...
            <div className="flex w-full items-center gap-3 rounded-full border border-gray-200 bg-white px-4 py-3 shadow-sm sm:w-auto">
              <div className="flex -space-x-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-white bg-blue-100 text-xs font-bold text-primary">
                  A
                </div>
                <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-white bg-orange-100 text-xs font-bold text-secondary">
                  B
                </div>
              ...
              <p className="text-sm text-gray-500 sm:text-base">
                <span className="font-bold text-primary">30K+</span> Active
                Students
              </p>
            </div>
          </div>
