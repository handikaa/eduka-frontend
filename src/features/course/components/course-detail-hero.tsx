      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="max-w-4xl">
          <div className="mb-5 flex flex-wrap gap-3">
            <span className="rounded-full bg-white px-4 py-2 text-sm font-bold text-[#0d22a8] shadow-sm">
              {primaryCategory}
            </span>

            <span className="rounded-full bg-[#F25019] px-4 py-2 text-sm font-bold capitalize text-white shadow-sm">
              {course.level}
            </span>
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-sm text-white/85">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-md">
              <Layers className="h-5 w-5 text-[#F25019]" />
              {course.lessons.length} Lessons
            </span>

            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-md">
              <Star className="h-5 w-5 fill-[#F25019] text-[#F25019]" />
              {course.rating_avg} Rating
            </span>

            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-md">
              <CalendarDays className="h-5 w-5 text-[#F25019]" />
