...
export function Navbar() {
  ...
  const instructorCoursesHref = "/instructor/courses";
  ...
  const renderDesktopAuthMenu = () => {
    if (!hasMounted) {
      return (
        <div className="h-10 w-20 rounded-md bg-gray-100" />
      );
    }
        ...
        >
          <div className="border-b border-gray-100 px-4 py-3">
            <p className="text-sm font-bold text-gray-900">
              {user?.role === "instructor" ? "Mentor" : "Student"}
            </p>
          ...
          <div className="p-2">
            ...
            {user?.role === "instructor" && (
              <button
                type="button"
                onClick={() => handleNavigate(instructorCoursesHref)}
